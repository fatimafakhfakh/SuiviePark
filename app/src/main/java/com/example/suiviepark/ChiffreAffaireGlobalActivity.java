...
import com.example.suiviepark.task.ChiffreAffaireGlobalTask;
...
public class ChiffreAffaireGlobalActivity extends AppCompatActivity {
    ...
    public static TextView txt_tot_ca  ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chiffre_affaire_global);



        txt_date_debut = findViewById(R.id.txt_date_debut);
        txt_date_fin = findViewById(R.id.txt_date_fin);
        txt_tot_ca = (TextView) findViewById(R.id.txt_tot);

        lv_list_ca = (ListView) findViewById(R.id.lv_list);
       ...
       /// cal1.add(Calendar.MONTH, -1);
        ...
        txt_date_debut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ChiffreAffaireGlobalActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    public void updateData() {
        ...
        ChiffreAffaireGlobalTask  chiffreAffaireGlobalTask   = new ChiffreAffaireGlobalTask( this  , date_debut,date_fin , lv_list_ca , pb  ) ;
        chiffreAffaireGlobalTask.execute();
    }
